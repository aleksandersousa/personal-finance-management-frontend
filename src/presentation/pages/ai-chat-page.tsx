...
export const AiChatPage: React.FC = () => {
  return (
    <div className='min-h-screen bg-slate-50 pt-16 lg:pb-8'>
      <div className='flex justify-center px-4 sm:px-6 lg:px-8 lg:ml-64 h-[calc(100vh-11.1rem)] lg:h-[calc(100vh-7rem)]'>
